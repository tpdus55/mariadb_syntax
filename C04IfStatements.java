...
//       BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
//       String num = br.readLine();
//       String result = (num.equals(answer))?"문이 열렸습니다":"비밀번호가 틀렸습니다";
//       System.out.println(result);

//       switch문 : if, else if, else if 등 여러조건식이 있을 때 조건문을 가독성 있게 표현한 구문
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        int num = Integer.parseInt(br.readLine());
//        num과 case의 값들은 equal관계이고, 구문마다 반드시 break를 넣어줘야함
//        default는 그외의 의미로서 else와 같은의미
